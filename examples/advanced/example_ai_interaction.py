...
from alicemultiverse.interface import AliceInterface, SearchRequest, TagRequest, GroupRequest
...
def simulate_ai_conversation():
    ...
    if response['success'] and response['data']:
        print(f"AI: Here are the hero shots from the music video project:")
        for asset in response['data']:
    ...
    print("USER: I just added new portraits to the inbox. Can you organize them and tag the best ones?\n")
    ...
    if organize_response['success']:
        ...
        if response['success'] and response['data']:
            ...
            tag_request = TagRequest(
                asset_ids=best_assets,
                tags=["best-portrait", "selected"],

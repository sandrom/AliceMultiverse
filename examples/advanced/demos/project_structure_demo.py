...
def test_project_structure():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("  Project: alice-1")
        print("  - Direct file: image1.jpg")
        print("  - Subfolder 'renders': image2.jpg")
        print("  - Nested 'exports/final': image3.jpg")
        ...
        assert (
            stats["by_project"]["alice-1"] == 3
        ), f"Expected 3 files in alice-1, got {stats['by_project']['alice-1']}"

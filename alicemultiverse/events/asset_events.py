...
@dataclass
class AssetGeneratedEvent(BaseEvent):
    """Fired when a new asset is generated by an AI provider."""

    # Required fields
    asset_id: str
    file_path: str
    generation_type: str  # 'image', 'video', 'audio', 'text'
    provider: str  # 'fal.ai', 'comfyui', etc.
    model: str  # 'flux-schnell', 'sdxl', etc.
    prompt: str

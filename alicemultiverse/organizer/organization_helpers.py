...
from ..core.constants import QUALITY_STAR_RANGE
...
def get_quality_from_folder_name(folder_name: str) -> Optional[int]:
...
def match_ai_source_patterns(filename: str, generators: List[str]) -> Optional[str]:

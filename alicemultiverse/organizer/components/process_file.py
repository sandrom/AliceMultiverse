...
class ProcessFileMixin:
    ...
    def _process_file(self, media_path: Path) -> OrganizeResult:
        ...
        try:
            ...
            return self._execute_file_operation(media_path, dest_path, analysis, project_folder)
    ...
    def _get_or_analyze_media(self, media_path: Path, project_folder: str) -> dict:
        ...
        if cached_metadata:
            ...
            # The cache might return the analysis directly or wrapped in 'analysis' key
            if isinstance(cached_metadata, dict) and "analysis" in cached_metadata:
                analysis = cached_metadata["analysis"]
            else:
                analysis = cached_metadata
    ...
    def _execute_file_operation(
        ...
        """
        # Copy or move file
        if hasattr(self.config.processing, 'copy_mode') and self.config.processing.copy_mode:
        ...
        # TODO: _update_search_index not implemented

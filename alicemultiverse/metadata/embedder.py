  ...
  <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    def _embed_jpeg_metadata(self, image_path: Path, metadata: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            exif_dict["0th"][piexif.ImageIFD.ImageDescription] = json.dumps(alice_data).encode('utf-8')
  ...
  <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    def _embed_webp_metadata(self, image_path: Path, metadata: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.info(f"Embedded basic metadata in WebP (full XMP support requires webpmux)")
            return True

...
class BRISQUEAssessor:
    ...
    def assess_quality(self, image_path: Path) -> Tuple[Optional[float], Optional[int]]:
    ...
    def _calculate_score(self, image_path: Path) -> Optional[float]:
        ...
        try:
            ...
            if image_quality is not None:
                ...
                if img.width > BRISQUE_MAX_DIMENSION or img.height > BRISQUE_MAX_DIMENSION:
                    img.thumbnail((BRISQUE_MAX_DIMENSION, BRISQUE_MAX_DIMENSION), 
...
def calculate_brisque_score(image_path: str) -> Optional[float]:
    """Calculate BRISQUE score for an image.
...
def get_quality_rating(score: Optional[float], config: dict) -> Optional[int]:

...
class SelectionService:
    ...
    def _get_selections_dir(self, project_id: str) -> Optional[Path]:
    ...
    def _get_selection_file(self, project_id: str, selection_id: str) -> Optional[Path]:
    ...
    def get_selection(self, project_id: str, selection_id: str) -> Optional[Selection]:
    ...
    def list_selections(
        self,
        project_id: str,
        status: Optional[SelectionStatus] = None,
        purpose: Optional[SelectionPurpose] = None,
    ) -> List[Selection]:

...
class ImprovementEngine:
    ...
    def _analyze_export_patterns(self) -> list[Improvement]:
        ...
        for platform in ["instagram_reel", "tiktok", "youtube_shorts"]:
            ...
            if platform_stats is not None and platform_stats["total_exports"] > 5:
                if platform_stats is not None and platform_stats["compatibility_score"] < 0.8:
                    improvements.append(Improvement(
        ...
        if quality_trends.get("complexity_trends") and quality_trends.get("user_satisfaction", 0) < 4:
            improvements.append(Improvement(
                ...
                metrics_before={
                    ...
                    if quality_trends is not None and quality_trends["complexity_trends"] else 0
                },
                expected_improvement={

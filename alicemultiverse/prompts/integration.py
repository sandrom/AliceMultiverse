...
from .models import ProviderType, PromptCategory
...
class PromptProviderIntegration:
    ...
    def extract_prompt_from_metadata(self, metadata: Dict[str, Any]) -> Optional[str]:
    ...
    def map_provider_to_enum(self, provider_name: str) -> Optional[ProviderType]:

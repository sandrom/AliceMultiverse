...
from alicemultiverse.database.models import Asset, AssetPath, AssetRelationship, Base, Project, Tag
...
class TestDatabaseModels:
    ...
    def test_asset_paths(self, db_session):
        ...
        # Add path history
        path1 = AssetPath(content_hash="abc123", file_path="/original/path.png", is_active=False)
        path2 = AssetPath(content_hash="abc123", file_path="/new/location/path.png", is_active=True)
    ...
    def test_tags(self, db_session):
        ...
        # Create asset
        asset = Asset(
            content_hash="abc123", file_path="/test.png", media_type="image", file_size=1000
        )
        db_session.add(asset)
        db_session.commit()
    ...
    def test_asset_relationships(self, db_session):
        ...
        parent = Asset(
            content_hash="parent123", file_path="/parent.png", media_type="image", file_size=1000
        )
        child = Asset(
            content_hash="child456", file_path="/child.png", media_type="image", file_size=1000
        )
...
class TestAssetRepository:
    ...
    def test_search_by_tags(self, repo, db_session):
        ...
        asset1 = Asset(
            content_hash="asset1", file_path="/1.png", media_type="image", file_size=1000
        )
        asset2 = Asset(
            content_hash="asset2", file_path="/2.png", media_type="image", file_size=1000
        )

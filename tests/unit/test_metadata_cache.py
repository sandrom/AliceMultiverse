...
from alicemultiverse.core.metadata_cache import MetadataCache, get_file_hash, get_content_hash
from alicemultiverse.core.types import AnalysisResult, CacheMetadata, MediaType
...
class TestMetadataCache:
    ...
    def test_media_type_enum_handling(self, cache, sample_file):
        ...
        analysis = {
            "source_type": "test",
            "media_type": MediaType.IMAGE  # Enum value
        }

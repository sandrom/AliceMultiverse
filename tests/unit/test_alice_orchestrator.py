...
from alicemultiverse.interface import (
    AliceOrchestrator, CreativeResponse, CreativeIntent,
    AliceAPI, ask_alice, ask_alice_sync
)
...
class TestAliceOrchestrator:
    ...
    def test_update_memory(self, orchestrator):
        ...
        orchestrator._update_memory(
            ...
            {'prompt': 'neon city scene', 'style': 'cyberpunk'}
        )
        ...
        orchestrator._update_memory(
            CreativeIntent.CREATE,
            {'prompt': 'another scene', 'style': 'cyberpunk'}
        )
...
class TestPatternExtraction:
    ...
    def test_enhance_prompt_with_style(self, orchestrator):
        ...
        orchestrator.memory.active_styles = {
            'mood': 'dark',
            'color': 'neon'
        }

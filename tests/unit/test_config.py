...
from alicemultiverse.core.config import DictConfig
from unittest.mock import patch, mock_open

from alicemultiverse.core.config import load_config, get_default_config
...
class TestConfig:
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("config_content,expected_has_paths", [

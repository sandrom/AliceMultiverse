...
class TestUnifiedCache:
    ...
    def test_backward_compatible_enhanced_cache(self):
        ...
        cache = EnhancedMetadataCacheAdapter(self.temp_dir, project_id="test-project")
        ...
        enhanced_meta = {
            "id": "test-asset",
            "tags": {"style": ["photorealistic"], "mood": ["calm"]},
            "quality": {"star_rating": 4},
        }

        cache.save_enhanced(self.test_image, self.test_metadata, 1.5, enhanced_meta)
    ...
    def test_backward_compatible_persistent_manager(self):
        ...
        manager = PersistentMetadataManagerAdapter(
            self.temp_dir, quality_thresholds={"5_star": {"min": 0, "max": 25}}
        )
...
class TestCacheMigration:
    ...
    def test_migration_imports(self):
        ...
        for old, new in replacements:
            assert (
                "MetadataCache" in old
                or "EnhancedMetadataCache" in old
                or "PersistentMetadataManager" in old
            )

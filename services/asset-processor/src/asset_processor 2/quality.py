...
class QualityPipeline:
    ...
    async def assess(self, file_path: Path, content_hash: str,
                    pipeline_mode: str = "basic") -> QualityAssessResponse:
    ...
    def _calculate_combined_score(self, brisque_score: Optional[float],
                                sightengine_score: Optional[float],
                                claude_assessment: Optional[Dict[str, Any]],
                                pipeline_mode: str) -> float:

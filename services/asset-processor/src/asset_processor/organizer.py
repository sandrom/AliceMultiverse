...
class AssetOrganizer:
    ...
    def __init__(self):
        ...
        self.organized_root = Path(
            self.config.get("paths.organized", "./organized")
        ).expanduser().resolve()
    
    async def plan_organization(self, file_path: Path, content_hash: str,
                               metadata: Dict[str, Any],
                               quality_rating: Optional[QualityRating] = None) -> OrganizePlanResponse:
    ...
    def _extract_source_type(self, metadata: Dict[str, Any]) -> str:
        ...
        if "ai_source" in metadata and metadata["ai_source"]:
    ...
    async def _get_next_sequence_number(self, date_folder: str, project_name: str,
                                       source_type: str, quality_folder: Optional[str]) -> int:
    ...
    def _generate_filename(self, project_name: str, sequence_number: int, 
                          extension: str) -> str:

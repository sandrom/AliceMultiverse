...
class AssetDiscoveredEvent(BaseEvent):
    ...
    # Optional fields
    source_type: Optional[str] = None  # AI generator if detected
    inbox_path: str = ""
...
class AssetOrganizedEvent(BaseEvent):
    ...
    # Optional fields
    quality_folder: Optional[str] = None  # e.g., "5-star"
...
class QualityAssessedEvent(BaseEvent):
    ...
    sightengine_score: Optional[float] = None
    claude_assessment: Optional[Dict[str, Any]] = None
